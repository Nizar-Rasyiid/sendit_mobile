  ...
  Future<void> updatePaymentMethod(String method) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final tripFare =
            double.tryParse(responseBody['total_harga'].toString()) ?? 0.0;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              _buildPaymentDetails(tripFare, platformFee,
                  extraPackageProtection, totalCost, paymentMethod),
...
Widget _buildPaymentDetails(double tripFare, double platformFee,
    double extraPackageProtection, double totalCost, String paymentMethod) {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      const Text(
      ...
      _buildPaymentDetailRow(
          'Platform fee', 'Rp ${platformFee.toStringAsFixed(0)}'),
      _buildPaymentDetailRow('Extra package protection',
          'Rp ${extraPackageProtection.toStringAsFixed(0)}'),
      const Divider(),
      _buildPaymentDetailRow('Total', 'Rp ${totalCost.toStringAsFixed(0)}',
          isTotal: true),
      const SizedBox(height: 8),
      _buildPaymentDetailRow(
